...
const Test = () => {
  ...
  return (
    <>
      ...
      <section className="flex flex-col md:flex-row bg-greyThree">
        <div className="log w-[50%] pt-24 sm:px-12 lg:px-[6rem] xl:px-[10rem] flex flex-col  justify-between">
          <div>
            <article>
          ...
          <p className="text-[13px] my-6 text-center">
        ...
        <div className="flex flex-col justify-center items-center mx-auto">
          <form
            ...
            className="flex flex-col text-greyFive rounded-md p-12 bg-greyFour gap-2 justify-center  mx-auto"
          >
            <p
              ref={errorRef}
              className={
