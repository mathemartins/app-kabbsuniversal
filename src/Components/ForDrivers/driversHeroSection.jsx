    ...
    <div className="bg-mainWhite  sm:px-12 lg:px-[6rem] xl:px-[10rem] font-poppins mt-16 sm:pt-12 text-mainWhite relative">
      <div className="hero w-full h-[40rem] xsm:py-36 py-24 flex flex-col justify-between px-6 ">
        <article className="text-center">
          <h2 className="text-[36px] mb-2">For Drivers</h2>
          <p>Become a Driver</p>
        </article>
        <div>
          <p className="mb-4 text-[12px] ml-2">Get KABBS for drivers</p>
          <div className="flex gap-4">
            <a href="https://play.google.com/store/apps/details?id=com.kabbsuniversal" target="_blank">
